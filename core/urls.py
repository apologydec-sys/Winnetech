...
urlpatterns = [
    ...
    path('superadmin/locations/', views.school_location_list, name='school_location_list'),
    path('superadmin/locations/create/', views.school_location_create, name='school_location_create'),
    path('superadmin/locations/<int:location_id>/edit/', views.school_location_update, name='school_location_update'),
    path('superadmin/locations/<int:location_id>/delete/', views.school_location_delete, name='school_location_delete'),
